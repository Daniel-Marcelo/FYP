...
<script>
	...
	function getLimitOrdersForUser(){
		return JSON.parse('${limitOrders}');
	}
	function getParticipatingGamesForUser(){
		return JSON.parse('${participatingGamesJSON}');
	}
</script>
</head>
<body>
	<div id="main-container">
		...
		<div id="main-content">
			...
			<div style =" width : 17%;">
				...
				<h2 style = "color: green;" id = "balance">Balance:</h2>
			</div>
			</div>
			<div>
				<div id="game-info-div">
					<div>
						...
						<div>
							<h1 align="center">My Trades</h1>
							<table id="myTransactionTable" class="table table-striped table-bordered"	>
								<thead>
									<tr>
										<th>Symbol</th>
										<th>Price</th>
						...
						<div>
							<h1 align="center">My Limit Orders</h1>
							<table id="limitOrdersTable" class="table table-striped table-bordered"	>
								<thead>
									<tr>
										<th>Symbol</th>
										<th>Desired Price</th>
