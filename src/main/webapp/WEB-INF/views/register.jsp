		...
		<div id="main-content">
			<div align="center" id="main">
				...
				<div id = "registration-div">
					...
					<div align = "center">
						<form:form id="registration" name="registration" action="save-user" method="post" modelAttribute="user" onSubmit="return performRegistrationValidation();">
							<table>
								<tr>
								...
								<tr>
								<tr>
									<td><div align = "center"><form:input path="password" type="password" class="form-field" placeholder="Password.." /></div>	</td>
								<tr>
								<tr>
									<td><form:input path="country" class="form-field" type="text" placeholder="Country.." /></td>
								<tr>
								<tr>
									<td><button type="submit" class="wide btn blue-submit">Register</button></td>
								</tr>
							</table>
